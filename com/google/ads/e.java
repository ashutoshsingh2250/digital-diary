...
public class e
{
    ...
    synchronized (new h(this, (com.google.ads.internal.h)this.a.i().g.a(), paramf, paramString, paramAdRequest, paramHashMap))
    {
      ...
      catch (InterruptedException localInterruptedException)
      {
        ...
        if ((???.c()) && (???.d()))
        {
          ...
          {
            ((Handler)m.a().c.a()).post(new Runnable(???, localView, paramf)
            {
              public void run()
              {
  ...
  private void b(c paramc, AdRequest paramAdRequest)
  {
    ...
    return;
    label294: ((Handler)m.a().c.a()).post(new Runnable(paramc)
    {
      public void run()
      {
        e.b(e.this).b(this.a);
  ...
  public void a(h paramh, View paramView)
  {
    ...
    this.a.n().a(g.a.a);
    f localf = this.b.a();
    ((Handler)m.a().c.a()).post(new Runnable(paramView, localf)
    {
      public void run()
      {
  ...
  public void a(h paramh, boolean paramBoolean)
  {
    if (!a(paramh, "onAdClicked()"))
      return;
    f localf = paramh.a();
    ((Handler)m.a().c.a()).post(new Runnable(localf, paramBoolean)
    {
      public void run()
      {
