...
public class UpdateOtherInformationActivity extends Activity
  implements ImportantMethod, View.OnClickListener
{
  ...
  public void databaseHelper()
  {
    ...
    this.db.UpdateOtherInfo(this.id, str1, str2, i);
    this.db.close();
  }
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    this.tracker.trackView("Update Other Information Digital_Diary");
    getIds();
    addListener();
 ...
 * Qualified Name:     com.girnar.online_digital_diary.ui.UpdateOtherInformationActivity
